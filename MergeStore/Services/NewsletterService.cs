...
public class NewsletterService : INewsletterService
{
    ...
    public async Task<OperationResult> SignUpForNewsletterAsync(CustomerCartInfo subscriber)
    {
    ...
    public async Task<IEnumerable<CustomerCartInfo>> GetActiveSubscribersAsync()
    {
